        ...
        <div class="login-container">
            ...
            <form action="/store" method="POST">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="description" id="password"  required>
                </div>
                <div class="input-group">
                    <label for="password">Price</label>
                    <input type="number" name="price" id="password"  required>
                </div>
                <div class="input-group">
                    <label for="password">Stock</label>
                    <input type="number" name="stock" id="password" required>
                </div>
